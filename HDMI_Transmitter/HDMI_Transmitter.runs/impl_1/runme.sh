...
HD_PWD='E:/HDMI_Transmitter/HDMI_Transmitter/HDMI_Transmitter.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_transmitter_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hdmi_transmitter_top.tcl -notrace
