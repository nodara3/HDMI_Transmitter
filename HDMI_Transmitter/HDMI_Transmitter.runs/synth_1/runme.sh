...
HD_PWD='E:/HDMI_Transmitter/HDMI_Transmitter/HDMI_Transmitter.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hdmi_transmitter_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hdmi_transmitter_top.tcl
